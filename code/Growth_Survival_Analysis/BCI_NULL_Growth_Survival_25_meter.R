#This is the same code as GLM_Figures_10_meters but it uses a different data set where neighborhood similarity was calculated over a 25-meter radius.
...
Null_Fixed <- read.csv("./data/Focal_Tree_Neighborhood/25_Meter_Analysis/BCI_INGA_Null_fixed_2018_Dec_11.csv",row.names = 1)
Null <- read.csv("./data/Focal_Tree_Neighborhood/25_Meter_Analysis/BCI_INGA_Null_2018_Dec_11.csv",row.names = 1)
BCI <- read.csv("./data/Focal_Tree_Neighborhood/25_Meter_Analysis/BCI_INGA_2018_Dec_11.csv")
BCI <- BCI[,-1]
